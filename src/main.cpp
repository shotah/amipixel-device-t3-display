        ...
        else
        {
            if (boards->pmu && id == LILYGO_AMOLED_147)
            {
                ...
                amoled.setChargingLedMode(
                    amoled.getChargingLedMode() != XPOWERS_CHG_LED_OFF ? XPOWERS_CHG_LED_OFF : XPOWERS_CHG_LED_ON);
            }
        }
        break;
...
void setup()
{
    ...
    Serial.println("Starting Factory Example with Serial Prints...");
                        ...
                        if (__coinId)
                        {
                            ...
                            if (quote)
                            {
                                ...
                                if (__currency)
                                {
                                    ...
                                    Serial.print(coinSubsribe[i].name);
                                    Serial.print(":");
                                    Serial.print("\t");
                                    Serial.print("ID:");
                                    Serial.println(id->valueint);
                                    Serial.print("\t");
                                    Serial.print("Price:");
                                    Serial.println(price->valuedouble);
                                    Serial.print("\t");
                                    Serial.print("1H:");
                                    Serial.println(percent_change_1h->valuedouble);
                                    Serial.print("\t");
                                    Serial.print("24H:");
                                    Serial.println(percent_change_24h->valuedouble);
                                    Serial.print("\t");
                                    Serial.print("7D:");
                                    Serial.println(percent_change_7d->valuedouble);
                                    if (id)
                                    {
